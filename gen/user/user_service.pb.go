...
func (x *CheckUserRolesRequest) GetRequiredRole() string {
	if x != nil {
...
func (x *CheckUserRolesResponse) GetUserRole() string {
	if x != nil {
		return x.UserRole
	}
	return ""
...
const file_user_user_service_proto_rawDesc = "" +
	"\n" +
	"\x17user/user_service.proto\x12\auser.v1\"}\n" +
	"\x04User\x12\x17\n" +
	...
	"\rrequired_role\x18\x02 \x01(\tR\frequiredRole\"T\n" +
	"\x16CheckUserRolesResponse\x12\x1d\n" +
	"\n" +
	"has_access\x18\x01 \x01(\bR\thasAccess\x12\x1b\n" +
	"\tuser_role\x18\x02 \x01(\tR\buserRole\"_\n" +
	...
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x14\n" +
	"\x05valid\x18\x02 \x01(\bR\x05valid2\x97\x03\n" +
	"\vUserService\x121\n" +
	"\aGetUser\x12\x17.user.v1.GetUserRequest\x1a\r.user.v1.User\x12Q\n" +
	"\x0eCheckUserRoles\x12\x1e.user.v1.CheckUserRolesRequest\x1a\x1f.user.v1.CheckUserRolesResponse\x12?\n" +
	...
	"\rValidateToken\x12\x1d.user.v1.ValidateTokenRequest\x1a\x1e.user.v1.ValidateTokenResponseB\x1fZ\x1dgrpc-exchange/gen/user;userv1b\x06proto3"
...
var file_user_user_service_proto_depIdxs = []int32{
	...
	10, // 5: user.v1.UserService.ValidateToken:input_type -> user.v1.ValidateTokenRequest
	0,  // 6: user.v1.UserService.GetUser:output_type -> user.v1.User
	3,  // 7: user.v1.UserService.CheckUserRoles:output_type -> user.v1.CheckUserRolesResponse
	5,  // 8: user.v1.UserService.Register:output_type -> user.v1.RegisterResponse
	7,  // 9: user.v1.UserService.Login:output_type -> user.v1.LoginResponse
	9,  // 10: user.v1.UserService.Logout:output_type -> user.v1.LogoutResponse
	11, // 11: user.v1.UserService.ValidateToken:output_type -> user.v1.ValidateTokenResponse
